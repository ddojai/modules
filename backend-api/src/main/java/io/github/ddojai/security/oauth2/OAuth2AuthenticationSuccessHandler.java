package io.github.ddojai.security.oauth2;

import io.github.ddojai.exception.BadRequestException;
import io.github.ddojai.security.TokenProvider;
import io.github.ddojai.config.AppProperties;
import io.github.ddojai.util.CookieUtils;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
  ...
  protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response,
    ...
    if (redirectUri.isPresent() && !isAuthorizedRedirectUri(redirectUri.get())) {
      throw new BadRequestException("Sorry! We've got an Unauthorized Redirect URI and can't " +
